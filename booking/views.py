...
def bookTechnician(request):
    ...
    paginator = Paginator(technicians, 6) 

    page_number = request.GET.get('page')
    page_obj = paginator.get_page(page_number)
    context = {
        'page_obj': page_obj,  # Pass the paginated queryset instead of 'technicians'
    }
...
stripe.api_key='sk_test_51NepFbJLevLStoLdLepnROAkMQ0NScqXbvY0bgBVPk5tV3w3vWqGqsG9x2nzbfcwsVoAM0Ubee6M8vz91Oi6MvIp00BMjxmrS0'
